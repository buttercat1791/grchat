...
- **Avoid writing tests without developer approval.** Excessive tests are just as bad as no tests at all. Get developer approval so that test coverage stays focused and incisive.
